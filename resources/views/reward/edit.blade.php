            ...
            <div class="card">
                ...
                <div class="container">
                    <div class="card-body">
                        ...
                        <form action="{{ route('reward.update', ['id'=>$reward->id]) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        @if ($col=='foto')
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-8">
                                                    <h5 class="small p-1">Sebelumnya</h5>
                                                    <img src="{{ $reward->foto }}" width="255" >
                                                </div>
                                        ...
                                        @elseif($col=='point')
                                            ...
                                            class="form-control form-control-sm {{ $errors->has($col) ? ' is-invalid' : '' }}" value="{{ old($col,$reward->$col) }}"
