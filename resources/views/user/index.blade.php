        ...
        <div class="container">
            <div class="card">
                ...
                <div class="card-body container">
                    <a href="{{ route('user.create',['kategori'=>'Admin']) }}" class="btn btn-outline-primary btn-sm border border-white-50">Tambah +</a>
                    <hr>
                    <table class="table table-striped table-borderless border border-white-50 table-sm small">
                                ...
                                <tr>
                                    ...
                                    <td class="text-right pr-2 dropdown dropleft">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item small" href="{{ route('user.edit', ['id'=>$admin->id]) }}">
                        ...
                        <a href="{{ route('user.create',['kategori'=>'Nasabah']) }}" class="btn btn-outline-primary btn-sm border border-white-50">Tambah +</a>
                        <hr>
                            ...
                            <tr>
                                ...
                                <td class="text-right pr-2 dropdown dropleft">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item small" href="{{ route('user.edit', ['id'=>$nasabah->id]) }}">
                                                <i class="far fa-edit"></i>
                                                Edit
                                            </a>

                                            <form style="display: inline;" method="post" action="{{ route('user.destroy', ['id'=>$nasabah->id]) }}">
                                                    <input type="hidden" name="_method" value="DELETE">
                                                    {{ csrf_field()}}
